...
bool Copter::ModeSpiral::init(bool ignore_checks)
{
...
uint32_t Copter::ModeSpiral::wp_distance() const
{
    return copter.spiral_nav->get_distance_to_target();
}

int32_t Copter::ModeSpiral::wp_bearing() const
{
